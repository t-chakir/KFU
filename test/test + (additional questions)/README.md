...
Извиняюсь за недоразумение! Вот оформленный вопрос с ответами, как вы просили:
...
- [x] e. Внутри списка параметров функции;
...
Извините за недоразумение. Вот как должно было быть:
...
**Вопрос 69**: Язык С++. Дана структура:
